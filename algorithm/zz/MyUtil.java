...
class MyUtil {
    ...
    class FastWriter {
        ...
        FastWriter print(byte b) {
            buf[tr++] = b;
            if (tr == BUF_SIZE) innerflush();
            return this;
        }

        FastWriter print(char c) {
            return print((byte) c);
        }

        FastWriter print(int x) {
        ...
        FastWriter print(double x, int precision) {
            if (x < 0) {
                print('-');
                x = -x;
            }
