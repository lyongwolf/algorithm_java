class RedBlackTree {
    ...
    public long rangeSum(int l, int r) {
        return sum[head] - lessSum(l) - moreSum(r);
    }

    public long lessSum(int k) {
        long ans = 0;
        int i = head;
        while (i != 0) {
            if (key[i] < k) {
    ...
    private void maintainFa(int o, int c, int v) {
        o = fa[o];
        while (o != 0) {
            sz[o] += c;
            sum[o] += v;
